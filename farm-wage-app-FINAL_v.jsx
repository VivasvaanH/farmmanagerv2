...
import { Plus, Users, Calendar, DollarSign, TrendingUp, Edit2, Trash2, Check, X, ChevronRight, ChevronLeft } from 'lucide-react';
...
export default function FarmWageManager() {
  // Theme definitions
  const themes = {
    default: {
      name: 'Farm Fresh',
      ...
      success: '#1e7d32', // Dark green for full day
      warning: '#f9a825', // Dark yellow for half day
      danger: '#b71c1c', // Blood red for absent
      successLight: '#2e7d32',
      warningLight: '#fbc02d',
      dangerLight: '#c62828'
    },
  ...
  const [currentTheme, setCurrentTheme] = useLocalStorage('farmTheme', 'default');
  ...
  const [seasonalData, setSeasonalData] = useState({ title: '', rateType: 'hourly', rate: '', startDate: '', endDate: '', totalConsumed: '' });
  const [showExpenseModal, setShowExpenseModal] = useState(false);
  const [editingExpense, setEditingExpense] = useState(null);
  const [expenseData, setExpenseData] = useState(() => ({ title: '', cost: '', purchaseDate: formatLocalDate(new Date()), unit: '', quantity: '' }));
  ...
  const addSeasonalWorkFromModal = () => {
    ...
    setSeasonalData({ title: '', rateType: 'hourly', rate: '', startDate: '', endDate: '', totalConsumed: '' });
  ...
  const addExpenseFromModal = () => {
    ...
    setExpenseData({ title: '', cost: '', purchaseDate: formatLocalDate(new Date()), unit: '', quantity: '' });
  ...
  const clearAllData = () => {
    setConfirmDialog({
      show: true,
      message: 'Sure, you want to Reset all data? This will delete all workers, attendance, payments, and notes. This cannot be undone.',
      onConfirm: () => {
        setWorkers([]);
        setAttendance([]);
        setPayments([]);
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '12px' }}>
                      ...
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                          ...
                          style={{
                            background: worker.active === false ? '#27ae60' : '#f39c12',
                            color: 'white',
                            border: 'none',
                            padding: '8px',
                            borderRadius: '8px',
                        ...
                        >
                          {worker.active === false ? <Check size={16} /> : '⏸️'}
                        </button>
                        <button
                          onClick={() => {
                    ...
                    <div style={{
                      ...
                      <div>
                        ...
                        <div style={{ 
                          fontSize: '18px', 
                          fontWeight: '700', 
                          color: earnings.finalBalance > 0 ? '#27ae60' : earnings.finalBalance < 0 ? '#e74c3c' : '#7f8c8d'
                        }}>
                      ...
                      <div style={{ marginBottom: '12px' }}>
                        {earnings.carriedForward !== 0 && (
                          <div style={{
                            ...
                            <span style={{ 
                              fontSize: '16px', 
                              fontWeight: '700',
                              color: earnings.carriedForward > 0 ? '#27ae60' : '#e74c3c'
                            }}>
                        ...
                        {earnings.totalCredits > 0 && (
                          <div style={{
                            ...
                            <span style={{ fontSize: '16px', fontWeight: '700', color: '#e74c3c' }}>
                              -₹{Math.round(earnings.totalCredits)}
                            </span>
                          </div>
                        )}
                        <div style={{
                                    ...
                                    <div style={{ flex: 1 }}>
                                      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
                                        <span style={{ 
                                          fontSize: '16px', 
                                          fontWeight: '700', 
                                          color: payment.type === 'credit' ? '#27ae60' : '#3498db'
                                        }}>
              ...
              <div style={{ display: 'flex', gap: '12px' }}>
                <button
                  ...
                  style={{
                    flex: 1,
                    padding: '12px',
                    border: newWorker.type === 'regular' ? '2px solid #27ae60' : '2px solid #e0e0e0',
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  ...
                  <button
                    ...
                    style={{
                      flex: 1,
                      padding: '12px',
                      border: paymentType === 'credit' ? '2px solid #27ae60' : '2px solid #e0e0e0',
            ...
            <div style={{ marginBottom: '24px' }}>
              ...
              {seasonalData.rate && seasonalData.totalConsumed && (
                <p style={{
                  ...
                  Total Cost: ₹{(parseFloat(seasonalData.rate) * parseFloat(seasonalData.totalConsumed)).toFixed(2)}
                </p>
              )}
            </div>
      ...
      {activeView === 'seasonal' && (
        <div style={{ padding: '20px' }}>
          <div style={{
            ...
            >
              <Plus size={18} /> Add Seasonal Work
            </button>
          </div>
                  ...
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '14px', color: '#7f8c8d' }}>
                        💰 ₹{work.rate}/{work.rateType === 'hourly' ? 'hour' : 'day'}
                      </div>
                    </div>
                    <button
                    ...
                    <div style={{
                      ...
                      <div style={{
                        ...
                        <span style={{ fontSize: '24px', fontWeight: '700', color: '#f39c12' }}>
                          ₹{(work.rate * work.totalConsumed).toFixed(2)}
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ fontSize: '24px', fontWeight: '700', color: '#e74c3c' }}>
                    ₹{expenses.reduce((sum, e) => sum + e.cost, 0).toFixed(2)}
                  </div>
                </div>
                <div>
                  <div style={{ fontSize: '14px', color: '#7f8c8d', marginBottom: '4px' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                      <div style={{ textAlign: 'right' }}>
                        ...
                        <div style={{ fontSize: '12px', color: '#7f8c8d' }}>
                          ₹{(expense.cost / expense.quantity).toFixed(2)}/{expense.unit}
                        </div>
                      </div>
            ...
            <div style={{ display: 'flex', gap: '12px' }}>
              <button
                ...
                style={{
                  flex: 1,
                  padding: '14px',
                  border: reportType === 'regular' ? '2px solid #27ae60' : '2px solid #e0e0e0',
          ...
          {workers.filter(w => (w.type === 'regular' || !w.type) && w.active !== false).length === 0 ? (
                  ...
                  return (
                    <>
                      ...
                      <StatCard 
                        ...
                        color={totalBalance > 0 ? '#27ae60' : totalBalance < 0 ? '#e74c3c' : '#7f8c8d'}
                      />
                      <StatCard 
                        icon={<Calendar size={20} />}
                        label="Total Days"
                    ...
                    <div style={{
                      ...
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ 
                          fontSize: '24px', 
                          fontWeight: '700', 
                          color: report.finalBalance > 0 ? '#27ae60' : report.finalBalance < 0 ? '#e74c3c' : '#7f8c8d'
                        }}>
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        {report.carriedForward !== 0 && (
                          <div style={{
                            ...
                            <span style={{ 
                              fontSize: '16px', 
                              fontWeight: '600',
                              color: report.carriedForward > 0 ? '#27ae60' : '#e74c3c'
                            }}>
                        ...
                        {report.totalCredits > 0 && (
                          <div style={{
                            ...
                            <span style={{ fontSize: '14px', color: '#7f8c8d' }}>Credit Deposit (D)</span>
                            <span style={{ fontSize: '16px', fontWeight: '600', color: '#e74c3c' }}>
                              -₹{Math.round(report.totalCredits)}
                            </span>
                          </div>
                        )}
                        <div style={{
            ...
            <>
              ...
              <div style={{
                ...
                >
                  <ChevronLeft size={18} /> Previous Year
                </button>
                <div style={{
                  fontSize: '20px',
                  fontWeight: '700',
                ...
                >
                  Next Year <ChevronRight size={18} />
                </button>
              </div>
                ...
                return (
                  <>
                    ...
                    <div style={{
                      ...
                      borderRadius: '12px',
                      border: `2px solid ${totalEarnings - totalPayments > 0 ? '#f39c12' : '#27ae60'}`
                    }}>
                      <div style={{
                        display: 'flex',
                        justifyContent: 'space-between',
                        ...
                        <div style={{
                          fontSize: '24px',
                          fontWeight: '700',
                          color: totalEarnings - totalPayments > 0 ? '#f39c12' : '#27ae60'
                        }}>
          ...
          <div style={{
            ...
            {!googleClientId || !googleApiKey ? (
              <div style={{
                ...
                >
                  {showGoogleConfig ? 'Hide Configuration' : '📝 Configure Google Drive'}
                </button>
              </div>
            ) : (
              <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              ...
              <button
                ...
                style={{
                  width: '100%',
                  padding: '16px',
                  border: (!googleClientId || !googleApiKey) ? '2px solid #bdc3c7' : '2px solid #27ae60',
                  background: 'white',
                  borderRadius: '12px',
                  display: 'flex',
                  alignItems: 'center',
                  ...
                  gap: '12px',
                  cursor: (!googleClientId || !googleApiKey) ? 'not-allowed' : 'pointer',
                  color: (!googleClientId || !googleApiKey) ? '#bdc3c7' : '#27ae60',
                  fontSize: '16px',
                  fontWeight: '600'
                }}
              >
              ...
              <div style={{
                ...
                <br/>• Backup: Saves JSON file directly to your Google Drive
                <br/>• Restore: Opens picker to select backup file from your Drive
    ...
    <div style={{ position: 'relative' }}>
      <button
        ...
        style={{
          ...
          fontSize: '11px',
          borderRadius: '8px',
          border: isToday ? '2px solid #27ae60' : 
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ 
                fontSize: '24px', 
                fontWeight: '700',
                color: carriedForward > 0 ? '#27ae60' : '#e74c3c',
                textAlign: 'center'
              }}>
...
function ActionButton({ icon, label, onClick, color }) {
  return (
    ...
    >
      ...
      <ChevronRight size={24} color={color} strokeWidth={3} />
    </button>
  );
}
